...
public class HMBlocks {
    ...
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(HowlingMoon.MODID);

    public static final DeferredBlock<Block> SILVER_ORE =
            registerBlock("silver_ore", () -> new Block(BlockBehaviour.Properties.of()
    ...
    public static final DeferredBlock<Block> DEEPSLATE_SILVER_ORE =
            registerBlock("deepslate_silver_ore", () -> new Block(BlockBehaviour.Properties.of()
